...
/*spliting the owner address using parsename function*/

SELECT * FROM nashville_housing

SELECT 
PARSENAME (REPLACE(owneraddress,',','.'), 1) FROM nashville_housing
...
/*changing OR replacing Y & N to YES  and NO in soldasvacant column*/
